...
public class Relatorio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recycleRelatorio);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(
                ...
                new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        Intent intent = new Intent(Relatorio.this, Update_Servico.class);
                    ...
                    public void onLongItemClick(View view, int position) {
                        ...
                        AlertDialog.Builder dialog = new AlertDialog.Builder(Relatorio.this);
    ...
    public void carregarListaTarefas(String pesquisa){
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener(){
            ...
            public boolean onQueryTextChange(String newText) {
                serviceAdapter.getFilterStatus().filter(newText);
                return false;
            }
        });
        return true;
